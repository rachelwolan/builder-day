  ...
  return (
    <>
      <section className="hero">
        ...
        <h1>Cursor for Data Science</h1>
        <p className="hero-subtitle">
          A practical guide to using Cursor for data science and data engineering workflows
        </p>
        <div style={{marginTop: '2rem', fontSize: '0.9375rem', color: 'var(--text-secondary)', lineHeight: '1.6'}}>
          <strong>For:</strong> Data Science and Data Engineering Teams<br />
        ...
        <div className="guide-content">
          <div className="guide-body">
            <section id="overview" className="guide-section">
              ...
              <p>
                Cursor enables data scientists and engineers to work more efficiently with notebooks, 
                databases, and data pipelines. Use AI-assisted development to generate analysis code, 
                scaffold transformations, and maintain reproducible, secure workflows.
              </p>
            </section>
            ...
            <section id="data-science" className="guide-section">
              <h2><span style={{color: 'var(--accent)', fontWeight: 600, marginRight: '0.5rem'}}>04</span>📊 Accelerating Data Science with Cursor</h2>
              <p>
